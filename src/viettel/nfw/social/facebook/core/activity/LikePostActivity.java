 ...
 * @author duongth5
 */
public class LikePostActivity implements IActivity {

    private static final Logger LOG = LoggerFactory.getLogger(LikePostActivity.class);

    public LikePostActivity() {
    }
