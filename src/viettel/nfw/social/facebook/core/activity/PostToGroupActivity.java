 ...
 * @author duongth5
 */
public class PostToGroupActivity implements IActivity {

    private static final Logger LOG = LoggerFactory.getLogger(PostToGroupActivity.class);

    public PostToGroupActivity() {
    }
