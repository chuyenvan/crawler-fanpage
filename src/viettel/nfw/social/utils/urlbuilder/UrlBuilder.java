 ...
 * the License.
 */
package viettel.nfw.social.utils.urlbuilder;

import viettel.nfw.social.utils.urlbuilder.url.Encoder;
import viettel.nfw.social.utils.urlbuilder.url.RuntimeURISyntaxException;
import viettel.nfw.social.utils.urlbuilder.url.Decoder;
import viettel.nfw.social.utils.urlbuilder.url.RuntimeMalformedURLException;
import viettel.nfw.social.utils.urlbuilder.url.UrlParameterMultimap;
import static viettel.nfw.social.utils.urlbuilder.url.UrlParameterMultimap.*;
 ...
 *
 * URL: http://www.ietf.org/rfc/rfc1738.txt URI: http://tools.ietf.org/html/rfc3986
 *
...
public final class UrlBuilder {
    ...
    /**
     * Construct a UrlBuilder from a full or partial URL string. Assume that the query paremeters were percent-encoded,
     * as the standard suggests, as UTF-8.
     */
     ...
     *
     * @throws NumberFormatException if the input contains a invalid percent-encoding sequence (%ax) or a non-numeric
     * port
     */
    ...
    /**
     * Replaces a query parameter. Existing parameters with this name are removed, and the new one added to the end of
     * the query string.
     */
