 ...
 * the License.
 */
package viettel.nfw.social.utils.urlbuilder.url;

import static viettel.nfw.social.utils.urlbuilder.url.Rfc3986Util.isFragmentSafe;
import static viettel.nfw.social.utils.urlbuilder.url.Rfc3986Util.isPChar;
import static viettel.nfw.social.utils.urlbuilder.url.Rfc3986Util.isUnreserved;
    ...
    protected String urlEncode(final String input, final boolean isPath, final boolean isFragment,
        ...
        for (int i = 0; i < Character.codePointCount(inputChars, 0, inputChars.length); i++) {
            ...
            if (isBmpCodePoint(codePoint)) {
                ...
                if ((isPath && isPChar(c) && c != '+') || isFragment && isFragmentSafe(c) || isUserInfo && c == ':'
                        || isUnreserved(c)) {
                    sb.append(c);
                    continue;
                } else {
